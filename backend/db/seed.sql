...
FROM (
  VALUES
    ((SELECT id FROM stores WHERE slug = 'roll-and-bowl'), 'dish', 'Авокадо ролл', 'avokado-roll', E'Нежный ролл с авокадо, огурцом и сливочным сыром.\nВес: 250 г', 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=800&q=80', 329.00, NULL, 'Хит', 'green', TRUE, 1),
    ((SELECT id FROM stores WHERE slug = 'roll-and-bowl'), 'dish', 'Боул с лососем', 'boul-s-lososem', E'Рис, лосось, эдамаме, манго и фирменный соус.\nВес: 320 г', 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=800&q=80', 489.00, NULL, 'Новинка', 'orange', TRUE, 2),
    ((SELECT id FROM stores WHERE slug = 'roll-and-bowl'), 'dish', 'Моти клубничный', 'moti-klubnichnyy', E'Легкий десерт с кремовой начинкой и ягодным акцентом.\nВес: 110 г', 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=800&q=80', 219.00, NULL, 'Десерт', 'pink', FALSE, 3),
    ((SELECT id FROM stores WHERE slug = 'roll-and-bowl'), 'dish', 'Комбо на вечер', 'kombo-na-vecher', E'Сет из роллов, соуса и двух напитков для компании.\nВес: 980 г', 'https://images.unsplash.com/photo-1611143669185-af224c5e3252?auto=format&fit=crop&w=800&q=80', 1190.00, 1290.00, 'Выгодно', 'blue', FALSE, 4),
    ((SELECT id FROM stores WHERE slug = 'burger-point'), 'dish', 'Бургер классический', 'burger-klassicheskiy', E'Сочная говяжья котлета, сыр чеддер и фирменный соус.\nВес: 290 г', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80', 390.00, NULL, 'Хит', 'orange', FALSE, 1),
    ((SELECT id FROM stores WHERE slug = 'burger-point'), 'dish', 'Комбо бургер и фри', 'kombo-burger-i-fri', E'Бургер, картофель фри и напиток.\nВес: 520 г', 'https://images.unsplash.com/photo-1550317138-10000687a72b?auto=format&fit=crop&w=800&q=80', 520.00, NULL, 'Комбо', 'blue', FALSE, 2),
    ((SELECT id FROM stores WHERE slug = 'burger-point'), 'dish', 'Чикен бургер', 'chiken-burger', E'Куриное филе в хрустящей панировке и свежие овощи.\nВес: 275 г', 'https://images.unsplash.com/photo-1606755962773-d324e9a13086?auto=format&fit=crop&w=800&q=80', 350.00, NULL, NULL, 'green', FALSE, 3),
    ((SELECT id FROM stores WHERE slug = 'pizza-station'), 'dish', 'Пицца Маргарита', 'pizza-margarita', E'Томаты, моцарелла и базилик на тонком тесте.\nВес: 540 г', 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80', 540.00, NULL, 'Классика', 'green', FALSE, 1),
    ((SELECT id FROM stores WHERE slug = 'pizza-station'), 'dish', 'Пицца Пепперони', 'pizza-pepperoni', E'Пепперони, моцарелла и насыщенный томатный соус.\nВес: 610 г', 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&w=800&q=80', 690.00, NULL, 'Хит', 'orange', FALSE, 2),
    ((SELECT id FROM stores WHERE slug = 'pizza-station'), 'dish', 'Пицца Четыре сыра', 'pizza-chetyre-syra', E'Моцарелла, дорблю, пармезан и сливочный соус.\nВес: 590 г', 'https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?auto=format&fit=crop&w=800&q=80', 760.00, NULL, NULL, 'blue', FALSE, 3),
    ((SELECT id FROM stores WHERE slug = 'sushi-wave'), 'dish', 'Ролл Филадельфия', 'roll-filadelfiya', E'Лосось, сливочный сыр и рис.\nВес: 260 г', 'https://images.unsplash.com/photo-1611143669185-af224c5e3252?auto=format&fit=crop&w=800&q=80', 540.00, NULL, 'Популярно', 'pink', FALSE, 1),
    ((SELECT id FROM stores WHERE slug = 'sushi-wave'), 'dish', 'Ролл Дракон', 'roll-drakon', E'Угорь, авокадо, соус унаги и кунжут.\nВес: 280 г', 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=800&q=80', 620.00, NULL, NULL, 'green', FALSE, 2),
    ((SELECT id FROM stores WHERE slug = 'sushi-wave'), 'dish', 'Сет суши мини', 'set-sushi-mini', E'Ассорти из роллов и суши на двоих.\nВес: 720 г', 'https://images.unsplash.com/photo-1553621042-f6e147245754?auto=format&fit=crop&w=800&q=80', 990.00, NULL, 'Сет', 'blue', FALSE, 3),
    ((SELECT id FROM stores WHERE slug = 'noodle-lab'), 'dish', 'Лапша удон с курицей', 'lapsha-udon-s-kuricey', E'Удон, овощи, курица и соус терияки.\nВес: 360 г', 'https://images.unsplash.com/photo-1617093727343-374698b1b08d?auto=format&fit=crop&w=800&q=80', 470.00, NULL, 'Вок', 'orange', FALSE, 1),
    ((SELECT id FROM stores WHERE slug = 'noodle-lab'), 'dish', 'Паста Альфредо', 'pasta-alfredo', E'Фетучини в сливочном соусе с пармезаном.\nВес: 340 г', 'https://images.unsplash.com/photo-1645112411341-6c4fd023714a?auto=format&fit=crop&w=800&q=80', 520.00, NULL, NULL, 'green', FALSE, 2),
    ((SELECT id FROM stores WHERE slug = 'noodle-lab'), 'dish', 'Рамен с курицей', 'ramen-s-kuricey', E'Насыщенный бульон, лапша и куриное филе.\nВес: 430 г', 'https://images.unsplash.com/photo-1617093727343-374698b1b08d?auto=format&fit=crop&w=800&q=80', 560.00, NULL, 'Суп', 'blue', FALSE, 3),
    ((SELECT id FROM stores WHERE slug = 'sweet-room'), 'dish', 'Шоколадный десерт', 'shokoladnyy-desert', E'Нежный десерт с тёмным шоколадом и кремом.\nВес: 140 г', 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=800&q=80', 260.00, NULL, 'Десерт', 'pink', FALSE, 1),
    ((SELECT id FROM stores WHERE slug = 'sweet-room'), 'dish', 'Тирамису', 'tiramisu', E'Классический итальянский десерт с кофе и маскарпоне.\nВес: 160 г', 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?auto=format&fit=crop&w=800&q=80', 290.00, NULL, NULL, 'orange', FALSE, 2),
    ((SELECT id FROM stores WHERE slug = 'sweet-room'), 'dish', 'Эклер ванильный', 'ekler-vanilnyy', E'Воздушное заварное тесто с кремовой начинкой.\nВес: 90 г', 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=800&q=80', 190.00, NULL, NULL, 'blue', FALSE, 3),
    ((SELECT id FROM stores WHERE slug = 'georgia-taste'), 'dish', 'Хинкали с говядиной', 'hinkali-s-govyadinoy', E'Сочные хинкали с мясной начинкой и бульоном.\nВес: 300 г', 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80', 420.00, NULL, 'Традиция', 'green', FALSE, 1),
    ((SELECT id FROM stores WHERE slug = 'georgia-taste'), 'dish', 'Хачапури по-аджарски', 'hachapuri-po-adzharski', E'Лодочка с сыром сулугуни, яйцом и сливочным маслом.\nВес: 380 г', 'https://images.unsplash.com/photo-1514326640560-7d063ef2aed5?auto=format&fit=crop&w=800&q=80', 530.00, NULL, 'Хит', 'orange', FALSE, 2),
    ((SELECT id FROM stores WHERE slug = 'georgia-taste'), 'dish', 'Сациви с курицей', 'sacivi-s-kuricey', E'Курица в ореховом соусе с пряными специями.\nВес: 330 г', 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80', 510.00, NULL, NULL, 'blue', FALSE, 3),
